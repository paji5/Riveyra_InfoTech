...
import ChatWidget from "./ChatWidget" // Ensure this import is correct
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            >
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                ...
                specialization lies in offering a comprehensive range of services, encompassing both Digital Marketing
                and Development.
              </p>
              <div>
...
- Component export ends.
    ...
    */}
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 pointer-events-none">
          ...
          {/* Chat Button - Above WhatsApp */}
          <motion.button
            onClick={toggleChat}
            className={`fixed bottom-24 left-6 w-12 h-12 ${
              isChatOpen ? "bg-red-500 hover:bg-red-600" : "bg-blue-500 hover:bg-blue-600"
            } text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 pointer-events-auto group`}
            whileHover={{ scale: 1.1, y: -2 }}
            whileTap={{ scale: 0.95 }}
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
          ...
          >
            <motion.div animate={{ rotate: isChatOpen ? 45 : 0 }} transition={{ duration: 0.3 }}>
              {isChatOpen ? (
